! function() {
          ...
          M = function P(t, n) {
            return k().then(function(i) {
              ...
              if ("[object Array]" === Object.prototype.toString.call(a))
                for (var l = 0; l < a.length; l++) a && a[l] && (o["msg." + l] = a[l], c && c[l] && (o["f." + l] = c[l]));
              return T(r, s, o, !1)
            }).then(function(e) {
      ...
      function c(e, n) {
        ...
        for (var x, A, T, C, O, k, N = new h(e); !N.eos();) {
          if (x = N.pos, T = N.scanUntil(a))
            for (var D = 0, I = T.length; D < I; ++D) C = T.charAt(D), o(C) ? g.push(f.length) : b = !0, f.push(["text", C, x, x + 1]), x += 1, "\n" === C && r();
          if (!N.scan(a)) break;
  ...
  180: [function(t, e, n) {
    ...
    function i() {
      ...
      }), e.htmlClass(), this.focusManager = new a(this.el), this._initializeSettings(), this._initializeMenu(), this._initializeSearch(), this._initializeStore(), this._initializeFlyoutListeners(), this._initializeListeners()
    }
    ...
    }, R._onStoreReject = function() {}, R._initializeSearch = function() {
      var t, e;
